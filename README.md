...
Each service uses Prisma as ORM. Our detailed Prisma guide can be found here: [Prisma Guide](https://dev.azure.com/NewsCenterInnoLab/NewsCenter/_git/news-api?path=/prisma.md&_a=preview).
